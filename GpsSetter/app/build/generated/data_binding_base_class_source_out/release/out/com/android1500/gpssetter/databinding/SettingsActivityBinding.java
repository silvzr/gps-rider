...
public final class SettingsActivityBinding implements ViewBinding {
  ...
  private SettingsActivityBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout appBar,
      @NonNull FragmentContainerView settingsContainer, @NonNull MaterialToolbar toolbar) {
  ...
  public static SettingsActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SettingsActivityBinding((CoordinatorLayout) rootView, appBar, settingsContainer,
          toolbar);
    }
